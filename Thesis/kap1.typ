= Einleitung (in Arbeit)<Kap1>
== Problemstellung
- Verschattungssimulationen sind wahrscheinlich sehr aufwändig im Engineering
- Sie sind meistens teuer
- Oft wird über in der Steuerung noch händisch Winkel eingetragen, bei denen es zu einer Blendung/Verschattung kommt
...
// Entwicklung einer durchgängigen Prozesskette (Data Workflow).
  - Identifikation der notwendigen Datenqualität des IFC-Modells
  - Entwicklung eines Proof of Concept (PoC) für Verschattungssimulationen anhand eines hochkomplexen Referenzprojekts
