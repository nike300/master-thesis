= Einleitung<Kap1>
Dieses erste Kapitel führt in die Thematik der dynamischen Verschattungssimulationen im Kontext der Gebäudeautomation ein. Es beleuchtet zunächst die Defizite konventioneller Sonnenschutzsteuerungen und formuliert darauf aufbauend die zentrale Zielsetzung der vorliegenden Arbeit. Im Anschluss werden das wirtschaftliche Potenzial des entwickelten Ansatzes erörtert, eine Marktabgrenzung zu kommerziellen Dienstleistern vorgenommen und der inhaltliche Aufbau der Arbeit dargelegt.
...
In der aktuellen Praxis der Gebäudeautomation stellt die Umsetzung solcher Systeme jedoch eine erhebliche Herausforderung dar. Die konventionelle Steuerung des Sonnenschutzes stützt sich im Regelfall primär auf die Messdaten lokaler Helligkeitssensoren auf dem Dach. Der Einsatz statischer Grenzwinkel in der @as stellt dabei bereits eine erweiterte Maßnahme dar. Beide Ansätze erfordern jedoch eine konservative Parametrierung und führen in dichten urbanen Umgebungen unweigerlich zu einer suboptimalen Anlagenregelung, da die reale Fremdverschattung durch benachbarte Bebauungen nicht präzise erfasst wird.
...
Darüber hinaus sind die normativen und informationstechnischen Grundlagen der aktuellen Raumautomation nicht auf die Verarbeitung dieser hochauflösenden Simulationsdaten ausgelegt. Die etablierten Standards, insbesondere die Funktionsblöcke nach VDI 3813~@vdi3813-2, basieren primär auf der Auswertung des globalen Sonnenstandes in Kombination mit lokalen, fest hinterlegten Parametern. Sie sind in ihrer aktuellen Architektur nicht darauf vorbereitet, dynamisch generierte, externe Verschattungsdaten aus einer vorgelagerten 3D-Simulation effizient zu integrieren. 
...
Den Abschluss der Arbeit bildet das fünfte Kapitel mit einer kritischen Diskussion der Ergebnisse und einem Fazit. Neben der Zusammenfassung der Erkenntnisse werden die Grenzen des entwickelten Prozesses aufgezeigt und ein Ausblick auf zukünftige Optimierungsmöglichkeiten gegeben.